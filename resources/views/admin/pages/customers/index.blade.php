                    ...
                    <div>
                        ...
                        <div class="btn-group me-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('mindo.customers.export.excel') }}">
                                    <i class="fas fa-file-excel me-2"></i> Excel</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('mindo.customers.export.csv') }}">
                                    <i class="fas fa-file-csv me-2"></i> CSV</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('mindo.customers.export.pdf') }}">
